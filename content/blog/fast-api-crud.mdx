...
You can find the full code on [GitHub](https://github.com/dennisivy/Fast-API-CRUD-App-Live-Stream-Code) or watch the stream recording here: https://www.youtube.com/watch?v=FOZNYBu8u18
